...
export const metadata: Metadata = {
  ...
  description:
    "Нүүдэлчин модон эдлэл цехтэй холбогдож, үнийн санал, хэмжээ авах болон захиалга өгөөрэй. Утас: +976 95116710",
};

const FAQS = [
  {
    q: "Захиалга хэд хоногт бэлэн болдог вэ?",
    a: "Бүтээгдэхүүний хэмжээ, сийлбэрийн нарийвчлалаас хамааран энгийн захиалга 5-10 хоног, том хэмжээний сийлбэртэй авдар болон иж бүрэн тавилга 10-20 хоногт бэлэн болдог.",
  },
  {
    q: "Хөдөө орон нутаг болон хот дотор хүргэлттэй юу?",
    a: "Тийм. Улаанбаатар хот дотор таны гэрийн үүдэнд хүргэж өгнө. Хөдөө орон нутгийн захиалагчдад зориулж бүтээгдэхүүнийг хамгаалалтын хайрцаг, саваар баглан орон нутгийн найдвартай унаанд тавьж хүргүүлдэг.",
  },
  {
    q: "Захиалгын урьдчилгаа хэдэн хувь байдаг вэ?",
    a: "Захиалга албан ёсоор баталгаажиж, мод зүсэлт эхлэхэд нийт үнийн дүнгийн 50%-ийн урьдчилгаа авдаг. Үлдсэн төлбөрийг бүтээгдэхүүн бэлэн болж, хэрэглэгч шалган хүлээж авах үед төлнө.",
  },
  {
    q: "Өөрийн санаа, зургийн дагуу тусгай захиалга өгч болох уу?",
    a: "Болно. Та өөрийн хүссэн хэмжээ, санаагаа манай Facebook Messenger-ээр илгээж үнэ төлбөргүй зөвлөгөө авч тооцоолуулж болно.",
  },
];
          ...
          <div className="lg:col-span-5 flex flex-col justify-between p-6 sm:p-8 rounded-2xl bg-brand-dark text-white shadow-xl">
            <div className="space-y-4">
              ...
              <p className="text-sm text-[#d0c4b6] leading-relaxed">
                Та манай Messenger рүү бүтээгдэхүүнийхээ нэр эсвэл сонгосон загварын зургийг илгээхэд л хангалттай. Бид танд дараах үйлчилгээг үзүүлнэ:
              </p>
              <ul className="space-y-2 text-xs sm:text-sm text-[#e6ded4]">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-brand-gold flex-shrink-0" />
                  <span>Хэмжээ, Өнгө, Хээ өлбөргүй тооцоолол</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-brand-gold flex-shrink-0" />
